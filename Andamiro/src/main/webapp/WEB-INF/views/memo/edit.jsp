...
<div id="content">
	...
	<div id="memo_wrap" class="container">
		<h1>::: Spring Memo Edit :::</h1>
		<%-- el표현식을 이용 ==> ${requestScope.message} --%>
				
		<%-- <%=request.getAttribute("message"); %> 와 동일 --%>
		
		<form name="frm" action="memoEditEnd" method="post" onsubmit="return check()">
			<!-- --------------------------------------- -->
			...
			<table id="memoTable">
				<tr>
					<th class="m1">작성자</th>
					<td>
						<input type="text" name="name" placeholder="Name" class="box sm" value="${memo.name}">
					</td>
				</tr>
